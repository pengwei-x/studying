...
public class SnCal {
    public static void main(String[] args) throws UnsupportedEncodingException,
        ...
        //aa7205b463d75a37cb5dcdf2bd313750
...
//        paramsMap.put("output", "json");
        paramsMap.put("ak", "XCfItBFpbWAR2QxAWCPKKY2SiY5pSwAx");
        paramsMap.put("output", "json");
...
//        http://api.map.baidu.com/reverse_geocoding/v3/?ak=XCfItBFpbWAR2QxAWCPKKY2SiY5pSwAx&output=json&coordtype=wgs84ll&location=31.225696563611,121.49884033194
        String wholeStr=new String("reverse_geocoding/v3" + paramsStr + "yoursk");
        // 对上面wholeStr再作utf8编码
